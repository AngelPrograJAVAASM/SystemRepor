                                    ...
                                    @foreach ($rpts as $rpt)
										...
										<td >{{ $rpt->id_employ }}</td>
                                            ...
                                            <td>
                                                    ...
                                                    <form action="{{ route('ShowReturnmr', $rpt->id) }}" method="GET" style="display: inline;">
                                                        <button type="submit" class="btn btn-sm btn-info">
                                                        <i class="fa fa-fw fa-eye"></i> {{ __('Ver respuesta') }}
                                                        </button>
                                                    </form>
                                                    <form action="{{ route('EditRtqr', $rpt->id) }}" method="GET" style="display: inline;">
                                                        <button type="submit" id="mover" class="btn btn-sm btn-success">
                                                        <i class="fa fa-fw fa-edit"></i> {{ __('Modificar datos') }}
                                                        </button>
                                                    </form>
