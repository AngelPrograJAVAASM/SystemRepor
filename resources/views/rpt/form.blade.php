<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20" >
            <label for="site" class="form-label">{{ __('Atnendido') }}</label>
            <label for="site" class="form-label">{{ __('Si') }}</label>
            <input  type="radio" id="attended" name="attended" value=1>
            <span class="checkmark"></span>
            <label for="site" class="form-label">{{ __('No') }}</label>
            <input  type="radio" id="attended" name="attended" value=0>
            <span class="checkmark"></span>
        </div>
        <div class="form-group mb-2 mb20">
